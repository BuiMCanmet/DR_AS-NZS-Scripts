<scriptConfig name="CPF" script="CPF">
  <params>
    <param name="cpf.commencement_time" type="float">1.0</param>
    <param name="cpf.completion_time" type="float">10.0</param>
    <param name="cpf.step_time_period" type="float">20.0</param>
